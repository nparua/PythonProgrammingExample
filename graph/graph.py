...
class AdjacencyMatrixGraph(Graph):
	...
	def add_edge(self, v1, v2, weight=1):
		...
		if weight <1:
			raise ValueError("An edge cannot have negative weight <1")
	...
	def get_adjacent_vertices(self, v):
		if v<0 or v>self.numVertices:
			raise ValueError("Cannot access vertex %s" % v)
...
class AdjacencySetGraph(Graph):
	...
	def add_edge(self, v1, v2, weight =1):
		...
		if weight !=1 :
			raise ValueError("we have not implemented weight !=1")
	...
	def get_edge_weight(self, v1, v2):
		return 1 # as we have set the weight to 1
